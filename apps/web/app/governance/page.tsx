  ...
  return (
    <main className="page-shell">
      <PageHero
        ...
        description="Governance is Juanity's restricted policy surface—not a generic company admin area. Production access will require verified identity, MFA and explicit Governance capabilities on every protected request."
        nav={[
      ...
      <p className="notice warning">Development shell only. This route currently displays synthetic policy data because live OIDC/MFA is intentionally deferred until runtime integration.</p>

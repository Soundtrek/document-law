...
export default async function GovernancePage() {
  ...
  return <main className="page-shell"><PageHero eyebrow="SAMMA GOVERNANCE" title="Record policy and platform controls" description="Access is checked against your SAMMA Governance capabilities." />

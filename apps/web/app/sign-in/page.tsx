...
export default async function SignInPage({ searchParams }: { searchParams: Promise<{ error?: string; login_hint?: string }> }) {
  const { error, login_hint: loginHint } = await searchParams;
  return <main className="page-shell">
    ...
    <section className="card">
      ...
      <SignInForm loginHint={loginHint} />

...
<div class="${properties.kcLogin!}">
  <header class="samma-auth-header">
    <div class="samma-auth-header-inner">
      <div class="samma-auth-brand">SAMMA</div>
      <div class="samma-auth-tagline">Employment Records &amp; Document Management</div>
    </div>
  </header>
  <div class="${properties.kcLoginContainer!}">
    <main class="samma-auth-main ${properties.kcLoginMain!}">
